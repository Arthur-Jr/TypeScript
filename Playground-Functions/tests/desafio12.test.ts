...
describe('Testa a função de Condição de existência de um triângulo', () => {
  ...
  it('Retorna false quando a medida de qualquer um dos lados seja menor que o valor absoluto da diferença entre essas medidas', () => {
  ...
  it('Retorna true quando a medida de qualquer um dos lados seja menor que a soma das medidas dos outros dois e maior que o valor absoluto da diferença entre essas medidas', () => {
