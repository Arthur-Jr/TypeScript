...
describe('Testa a função que Codifique e Decodifique', () => {
  it('Retorna uma string codificada quando a função encode for utilizada', () => {
  ...
  it('Retorna uma string decodificada quando a função decode for utilizada', () => {
