...
describe('Testa a função de Número de telefone', () => {
  it('Retorna a string "Array com tamanho incorreto." caso o array tenha o tamanho diferente de 11', () => {
  ...
  it('Retorna a string "não é possível gerar um número de telefone com esses valores" caso algum dos números da array seja menor que 0', () => {
  ...
  it('Retorna a string "não é possível gerar um número de telefone com esses valores" caso algum número da array seja maior que 9', () => {
  ...
  it('Retorna a string "não é possível gerar um número de telefone com esses valores" caso algum número da array se repeti 3 vezes ou mais', () => {
  ...
  it('Retorna um número de telefone, respeitando parênteses, traços e espaços caso os números da array estejam de acordo com as restrições', () => {
