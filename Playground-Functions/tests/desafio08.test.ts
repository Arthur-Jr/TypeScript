...
describe('Testa a função FizzBuzz', () => {
  ...
  it('Retorna as strings [\'bug!\', \'fizz\'] quando é passado os parâmetros [7, 9] para função fizzBuzz', () => {
    expect(fizzBuzz([7, 9])).toEqual(['bug!', 'fizz']);
  });

  it('Retorna as strings [\'fizz\', \'buzz\'] quando é passado os parâmetros [9, 25] para função fizzBuzz', () => {
